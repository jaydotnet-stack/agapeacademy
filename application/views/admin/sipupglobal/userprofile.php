                                            ...
                                            <div class="d-md-flex align-items-center">
                                                ...
                                                <?php 
                                                    if(isset($_SESSION['userinformation']) && !empty($_SESSION['userinformation']) && $_SESSION['userinformation']->users_account_passport_tag != 'F'){?>
                                                        <img src="<?php echo base_url() . 'staffpicture/'.$_SESSION['userinformation']->users_account_id.".jpg"; ?>" id="uploadedImageX" name="uploadedImageX" class="rounded-circle shadow" width="130" height="130" alt="" />                                                       
                                                    <?php }else{ ?>
                                                        <img src="<?php echo base_url() . 'adminresources/images/avatars/avatar-1.png'; ?>" id="uploadedImageX" name="uploadedImageX" class="rounded-circle shadow" width="130" height="130" alt="" />
                                                    <?php } 
                                                ?>                                                
                                                </div>
                                                        ...
                                                        <div class="media-body ml-3">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 col-lg-3">
                                                                    <img src="adminresources/images/gallery/35.jpg" class="img-thumbnail" alt="">
                                                                </div>
                                                                <div class="col-12 col-lg-3">
                                                                    <img src="adminresources/images/gallery/36.jpg" class="img-thumbnail" alt="">
                                                                </div>
                                                                <div class="col-12 col-lg-3">
                                                                    <img src="adminresources/images/gallery/37.jpg" class="img-thumbnail" alt="">
                                                                </div>
                                                                <div class="col-12 col-lg-3">
                                                                    <img src="adminresources/images/gallery/38.jpg" class="img-thumbnail" alt="">
                                                                </div>
                                                            </div>
                                                            <hr/>
                                                        </div>
                ...
                $.ajax({
                    ...
                    success: function (data){ 
                        ...
                        if(data == -1){
                            ...
                            $("#uploadedImage").attr('src', baseUrl + 'staffpicture/' + data + '.jpg' + `?v=${new Date().getTime()}`);      
                            $("#uploadedImageX").attr('src', baseUrl + 'staffpicture/' + data + '.jpg' + `?v=${new Date().getTime()}`);                                
                            //location.reload();   
                        }
                    }
                });        
