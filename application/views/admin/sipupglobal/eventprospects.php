...
<body>
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
						<div class="breadcrumb-title pr-3">Event</div>
						<div class="pl-3">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb mb-0 p-0">
									<li class="breadcrumb-item"><a href="javascript:;"><i class='bx bx-home-alt'></i></a>
									</li>
									<li class="breadcrumb-item active" aria-current="page">Prospect(s)</li>
								</ol>
							</nav>
						</div>
					</div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $.get(baseUrl + "admin/fetcheventprospect").done(function(data){
                ...
                if(data != "" && data!=0){
                    ...
                    for(var i = 0; i < data.length; i++) {
                        ...
                        tableObjBuilder +="<tr>"
                            ...
                            tableObjBuilder +="<td>"+data[i].event_prospects_fullname+"</td>"
                            tableObjBuilder +="<td>"+data[i].event_prospects_email+"</td>"
                            tableObjBuilder +="<td>"+data[i].event_prospects_url+"</td>"
                            tableObjBuilder +="<td>"+data[i].event_prospects_timestamp+"</td>"
                        tableObjBuilder +="</tr>"
                        btnAction = "";
                    }
                    $("#tbl_prospects").html(tableObjBuilder);
                }else if(data == 0) {
                    // do nothing
                }else{
                    // alert(data);
