...
<body>
						...
						<div class="pl-3">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb mb-0 p-0">
									...
									<li class="breadcrumb-item active" aria-current="page">Inboxes</li>
								</ol>
							</nav>
						</div>
					</div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $.get(baseUrl + "admin/fetchmessages").done(function(data){
                ...
                if(data != "" && data!=0){
                    ...
                    for(var i = 0; i < data.length; i++) {
                        ...
                        tableObjBuilder +="<tr>"
                            ...
                            tableObjBuilder +="<td>"+data[i].contact_us_name+"</td>"
                            tableObjBuilder +="<td>"+data[i].contact_us_email+"</td>"
                            tableObjBuilder +="<td>"+data[i].contact_us_subject+"</td>"
                            tableObjBuilder +="<td>"+data[i].contact_us_timestamp+"</td>"
                        tableObjBuilder +="</tr>"
                        btnAction = "";
                    }
                    $("#tbl_messages").html(tableObjBuilder);
                }else if(data == 0) {
                    // do nothing
                }else{
                    // alert(data);
