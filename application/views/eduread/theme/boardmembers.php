		...
		<div class="row teachers-wapper-02">
			<div class="col-sm-6 col-md-3 teacher-single">
				<figure class="text-center">
					...
					<div class="teachers-name">
						<h3><a href="<?php echo base_url() .'clients/boardmembersprofile?boardmemberid=bishop'; ?>">Bishop Felix Remi Adejumo</a></h3>
						<span>Founder and the Visionarian</span>
					</div>
					<figcaption>
			...
			<div class="col-sm-6 col-md-3 teacher-single">
				<figure class="text-center">
					...
					<div class="teachers-name">
						<h3><a href="<?php echo base_url() .'clients/boardmembersprofile?boardmemberid=fola-adebayo'; ?>">Prof. Fola-Adebayo</a></h3>
			...
			<div class="col-sm-6 col-md-3 teacher-single">
				<figure class="text-center">
					...
					<div class="teachers-name">
						<h3><a href="<?php echo base_url() .'clients/boardmembersprofile?boardmemberid=akinrinwa Akinbowale'; ?>">Akinrinwa Akinbowale</a></h3>
						<span>Board member</span>
					</div>
					<figcaption>
						<ul class="list-unstyled">
