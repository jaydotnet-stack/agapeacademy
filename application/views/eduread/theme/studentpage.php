...
<!-- Mirrored from ecologytheme.com/theme/eduread/teachers-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Jul 2022 12:16:55 GMT -->
<head>
    <meta charset="utf-8">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1><?php echo $_GET['class']; ?></h1>
						<p><span><a href="#">Home <i class='fa fa-angle-right'></i></a></span><span class="b-active"> <?php echo $_GET['class']; ?></span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
...
<!-- Mirrored from ecologytheme.com/theme/eduread/teachers-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Jul 2022 12:16:58 GMT -->
</html>
